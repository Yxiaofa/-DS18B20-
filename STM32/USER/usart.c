...
u8 flag1,flag2;
u8 temp1,temp2,temp3,temp4,tempsum1,tempsum2;//温度1/2
...
if(USART_RX_STA&0x8000)//如果zigbee接收成功
		{
			if(USART_RX_BUF[0]==0x01)
			{
				...
				OLED_ShowNum(48,1,tempsum1,2,16);		//显示温度整数
				flag1=1;
			}
			if(USART_RX_BUF[0]==0x02)
			{
				...
				OLED_ShowNum(48,5,tempsum2,2,16);		//显示温度整数
				flag2=1;
			}
